...
while True:
    ...
    # Encontrar rostos no frame redimensionado utilizando o modelo CNN:

    # Baseado em redes neurais convolucionais profundas. O modelo é treinado para detectar rostos analisando padrões complexos 
    # em várias camadas.
    
    # Oferece detecção mais robusta para ângulos diferentes, variações de luz e qualidade de imagem.
